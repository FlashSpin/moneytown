...
test("the auth schema ships outside the globbed directory", () => {
  ...
  assert.ok(
    pending.every((m) => m.name !== AUTH_MIGRATION),
    "0001_auth.sql must not be picked up from the top-level migrations dir — it lives under migrations/auth/ until sign-in is turned on",
  );
