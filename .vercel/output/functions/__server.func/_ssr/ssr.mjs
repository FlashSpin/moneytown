...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dwn6So8X.mjs");
...
var manifest = {
	"3cedff8769b43d7e6838f374b6d52e6410d6f51fe8e1f57afe506aaa1694eb28": {
		functionName: "fetchTape_createServerFn_handler",
		importer: () => import("./tape-B1pkn6F7.mjs")
	},
	"a331e34b76dcee0e3eca78c1969b27e9be9a9cbddb14f82921c74a08169a8b53": {
		functionName: "fetchChainBalance_createServerFn_handler",
		importer: () => import("./chain-BYNY_ko6.mjs")
	},
	"ef53e6188f67bbae2eeca620676d13792f19f46855bfc6121e5e7494985c7cf5": {
		functionName: "askCounsel_createServerFn_handler",
		importer: () => import("./counsel-MTVlhExo.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-FX2mVsUA.mjs").then((n) => n.t),
